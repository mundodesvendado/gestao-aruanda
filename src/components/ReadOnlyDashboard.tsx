...
import { Users, DollarSign, Calendar, TrendingUp, Star, Moon, Eye, Lock } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-2 bg-blue-50 dark:bg-blue-900/20 px-3 py-2 rounded-lg">
            ...
            <span className="text-sm text-blue-700 dark:text-blue-300 font-medium">Modo Leitura</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg border border-yellow-200 dark:border-yellow-800">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h3 className="font-medium text-yellow-900 dark:text-yellow-300">Acesso Limitado</h3>
            <p className="text-sm text-yellow-800 dark:text-yellow-300">
              Você possui acesso limitado ao sistema. Para editar dados, entre em contato com um administrador.
            </p>
          </div>
        </div>
      </div>
